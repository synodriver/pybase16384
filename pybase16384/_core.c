...
static uint8_t __pyx_f_11pybase16384_5_core_PyFile_Check(PyObject *); /*proto*/
static int __pyx_f_11pybase16384_5_core_encode_len(int, int __pyx_skip_dispatch); /*proto*/
static int __pyx_f_11pybase16384_5_core_decode_len(int, int, int __pyx_skip_dispatch); /*proto*/
static PyObject *__pyx_f_11pybase16384_5_core__encode(__Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
static PyObject *__pyx_f_11pybase16384_5_core__decode(__Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
static int __pyx_f_11pybase16384_5_core__encode_into(__Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
static int __pyx_f_11pybase16384_5_core__decode_into(__Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
...
static uint8_t __pyx_f_11pybase16384_5_core_PyFile_Check(PyObject *__pyx_v_file) {
  uint8_t __pyx_r;
...
static int __pyx_f_11pybase16384_5_core_encode_len(int __pyx_v_dlen, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_r;
  __Pyx_RefNannyDeclarations
...
static int __pyx_f_11pybase16384_5_core_decode_len(int __pyx_v_dlen, int __pyx_v_offset, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_r;
  __Pyx_RefNannyDeclarations
...
static int __pyx_f_11pybase16384_5_core__encode_into(__Pyx_memviewslice __pyx_v_data, __Pyx_memviewslice __pyx_v_dest, CYTHON_UNUSED int __pyx_skip_dispatch) {
...
static int __pyx_f_11pybase16384_5_core__decode_into(__Pyx_memviewslice __pyx_v_data, __Pyx_memviewslice __pyx_v_dest, CYTHON_UNUSED int __pyx_skip_dispatch) {
  size_t __pyx_v_input_size;
  size_t __pyx_v_output_size;
  size_t __pyx_v_output_buf_size;
  int __pyx_r;
...
static void __pyx_f_11pybase16384_5_core_decode_file(PyObject *__pyx_v_input, PyObject *__pyx_v_output, CYTHON_UNUSED int __pyx_skip_dispatch, struct __pyx_opt_args_11pybase16384_5_core_decode_file *__pyx_optional_args) {
  int32_t __pyx_v_buf_rate = ((int32_t)10);
  PyObject *__pyx_v_chunk = NULL;
  int32_t __pyx_v_current_buf_len;
  size_t __pyx_v_output_size;
